...
namespace Rocosa.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                //var user = CreateUser(); //vamos a usar UsuarioAlicacion
                ...
                if (result.Succeeded) //indica cuando usuario se crea correctamente
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirmar tu Email",
                        $"Please confirm your account by <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>Haz Click Aquí</a>.");
